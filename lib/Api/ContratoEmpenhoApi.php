...
/**
 * ContratoEmpenhoApi Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
...
/**
    ...
    public function consultarContratoRequest($cnpj, $ano, $sequencial, string $contentType = self::contentTypes['consultarContrato'][0])
    {
        ...
        if ($sequencial < 1) {
            throw new \InvalidArgumentException('invalid value for "$sequencial" when calling ContratoEmpenhoApi.consultarContrato, must be bigger than or equal to 1.');
        }
    ...
    public function consultarContrato1Request($cnpj, $ano, $sequencial, $pagina = null, $tamanho_pagina = null, string $contentType = self::contentTypes['consultarContrato1'][0])
    {
        ...
        if ($sequencial < 1) {
            throw new \InvalidArgumentException('invalid value for "$sequencial" when calling ContratoEmpenhoApi.consultarContrato1, must be bigger than or equal to 1.');
        }
        
        if ($pagina !== null && $pagina < 1) {
            throw new \InvalidArgumentException('invalid value for "$pagina" when calling ContratoEmpenhoApi.consultarContrato1, must be bigger than or equal to 1.');
        }
        
        if ($tamanho_pagina !== null && $tamanho_pagina < 1) {
            throw new \InvalidArgumentException('invalid value for "$tamanho_pagina" when calling ContratoEmpenhoApi.consultarContrato1, must be bigger than or equal to 1.');
        }
    ...
    public function consultarContrato2Request($cnpj, $ano, $sequencial, string $contentType = self::contentTypes['consultarContrato2'][0])
    {
        ...
        if ($sequencial < 1) {
            throw new \InvalidArgumentException('invalid value for "$sequencial" when calling ContratoEmpenhoApi.consultarContrato2, must be bigger than or equal to 1.');
        }
    ...
    public function consultarContratosContratacaoRequest($cnpj, $ano_contratacao, $sequencial_contratacao, $pagina, $tamanho_pagina = null, string $contentType = self::contentTypes['consultarContratosContratacao'][0])
    {
        ...
        if ($sequencial_contratacao < 1) {
            throw new \InvalidArgumentException('invalid value for "$sequencial_contratacao" when calling ContratoEmpenhoApi.consultarContratosContratacao, must be bigger than or equal to 1.');
        }
        ...
        if ($pagina < 1) {
            throw new \InvalidArgumentException('invalid value for "$pagina" when calling ContratoEmpenhoApi.consultarContratosContratacao, must be bigger than or equal to 1.');
        }
        
        if ($tamanho_pagina !== null && $tamanho_pagina > 50) {
            throw new \InvalidArgumentException('invalid value for "$tamanho_pagina" when calling ContratoEmpenhoApi.consultarContratosContratacao, must be smaller than or equal to 50.');
        }
        if ($tamanho_pagina !== null && $tamanho_pagina < 10) {
            throw new \InvalidArgumentException('invalid value for "$tamanho_pagina" when calling ContratoEmpenhoApi.consultarContratosContratacao, must be bigger than or equal to 10.');
        }
    ...
    public function inserirArquivo1Request($cnpj, $ano, $sequencial, $titulo_documento, $tipo_documento_id, $arquivo, string $contentType = self::contentTypes['inserirArquivo1'][0])
    {
        ...
        if ($sequencial < 1) {
            throw new \InvalidArgumentException('invalid value for "$sequencial" when calling ContratoEmpenhoApi.inserirArquivo1, must be bigger than or equal to 1.');
        }
        ...
        if (strlen($titulo_documento) > 255) {
            throw new \InvalidArgumentException('invalid length for "$titulo_documento" when calling ContratoEmpenhoApi.inserirArquivo1, must be smaller than or equal to 255.');
        }
        if (strlen($titulo_documento) < 0) {
            throw new \InvalidArgumentException('invalid length for "$titulo_documento" when calling ContratoEmpenhoApi.inserirArquivo1, must be bigger than or equal to 0.');
        }
        ...
        if ($tipo_documento_id > 18) {
            throw new \InvalidArgumentException('invalid value for "$tipo_documento_id" when calling ContratoEmpenhoApi.inserirArquivo1, must be smaller than or equal to 18.');
        }
        if ($tipo_documento_id < 12) {
            throw new \InvalidArgumentException('invalid value for "$tipo_documento_id" when calling ContratoEmpenhoApi.inserirArquivo1, must be bigger than or equal to 12.');
        }
    ...
    public function recuperarArquivo1Request($cnpj, $ano, $sequencial, $sequencial_documento, $ignorar_exclusao = null, string $contentType = self::contentTypes['recuperarArquivo1'][0])
    {
        ...
        if ($sequencial < 1) {
            throw new \InvalidArgumentException('invalid value for "$sequencial" when calling ContratoEmpenhoApi.recuperarArquivo1, must be bigger than or equal to 1.');
        }
        ...
        if ($sequencial_documento < 1) {
            throw new \InvalidArgumentException('invalid value for "$sequencial_documento" when calling ContratoEmpenhoApi.recuperarArquivo1, must be bigger than or equal to 1.');
        }
    ...
    public function recuperarInformacoesDocumentosContratoRequest($cnpj, $ano, $sequencial, $pagina = null, $tamanho_pagina = null, string $contentType = self::contentTypes['recuperarInformacoesDocumentosContrato'][0])
    {
        ...
        if ($sequencial < 1) {
            throw new \InvalidArgumentException('invalid value for "$sequencial" when calling ContratoEmpenhoApi.recuperarInformacoesDocumentosContrato, must be bigger than or equal to 1.');
        }
        
        if ($pagina !== null && $pagina < 1) {
            throw new \InvalidArgumentException('invalid value for "$pagina" when calling ContratoEmpenhoApi.recuperarInformacoesDocumentosContrato, must be bigger than or equal to 1.');
        }
        
        if ($tamanho_pagina !== null && $tamanho_pagina < 1) {
            throw new \InvalidArgumentException('invalid value for "$tamanho_pagina" when calling ContratoEmpenhoApi.recuperarInformacoesDocumentosContrato, must be bigger than or equal to 1.');
        }
    ...
    public function removerContratoRequest($cnpj, $ano, $sequencial, $exclusao_dto = null, string $contentType = self::contentTypes['removerContrato'][0])
    {
        ...
        if ($sequencial < 1) {
            throw new \InvalidArgumentException('invalid value for "$sequencial" when calling ContratoEmpenhoApi.removerContrato, must be bigger than or equal to 1.');
        }
    ...
    public function removerDocumentoContrato1Request($cnpj, $ano, $sequencial, $sequencial_documento, $exclusao_dto, string $contentType = self::contentTypes['removerDocumentoContrato1'][0])
    {
        ...
        if ($sequencial < 1) {
            throw new \InvalidArgumentException('invalid value for "$sequencial" when calling ContratoEmpenhoApi.removerDocumentoContrato1, must be bigger than or equal to 1.');
        }
        ...
        if ($sequencial_documento < 1) {
            throw new \InvalidArgumentException('invalid value for "$sequencial_documento" when calling ContratoEmpenhoApi.removerDocumentoContrato1, must be bigger than or equal to 1.');
        }
    ...
    public function retificarContratoRequest($cnpj, $ano, $sequencial, $alterar_contrato_dto, string $contentType = self::contentTypes['retificarContrato'][0])
    {
        ...
        if ($sequencial < 1) {
            throw new \InvalidArgumentException('invalid value for "$sequencial" when calling ContratoEmpenhoApi.retificarContrato, must be bigger than or equal to 1.');
        }
