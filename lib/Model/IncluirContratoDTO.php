...
/**
 * IncluirContratoDTO Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class IncluirContratoDTO implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'IncluirContratoDTO';
    ...
    */
    ...
    public function setSequencialCompra($sequencial_compra)
    {
        ...
        if (($sequencial_compra < 1)) {
            throw new \InvalidArgumentException('invalid value for $sequencial_compra when calling IncluirContratoDTO., must be bigger than or equal to 1.');
        }
    ...
    public function setTipoContratoId($tipo_contrato_id)
    {
        ...
        if (($tipo_contrato_id < 1)) {
            throw new \InvalidArgumentException('invalid value for $tipo_contrato_id when calling IncluirContratoDTO., must be bigger than or equal to 1.');
        }
    ...
    public function setCategoriaProcessoId($categoria_processo_id)
    {
        ...
        if (($categoria_processo_id < 1)) {
            throw new \InvalidArgumentException('invalid value for $categoria_processo_id when calling IncluirContratoDTO., must be bigger than or equal to 1.');
        }
    ...
    public function setNomeRazaoSocialFornecedor($nome_razao_social_fornecedor)
    {
        ...
        if ((mb_strlen($nome_razao_social_fornecedor) > 255)) {
            throw new \InvalidArgumentException('invalid length for $nome_razao_social_fornecedor when calling IncluirContratoDTO., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($nome_razao_social_fornecedor) < 0)) {
            throw new \InvalidArgumentException('invalid length for $nome_razao_social_fornecedor when calling IncluirContratoDTO., must be bigger than or equal to 0.');
        }
    ...
    public function setValorInicial($valor_inicial)
    {
        ...
        if (($valor_inicial < 0)) {
            throw new \InvalidArgumentException('invalid value for $valor_inicial when calling IncluirContratoDTO., must be bigger than or equal to 0.');
        }
    ...
    public function setNumeroParcelas($numero_parcelas)
    {
        ...
        if (($numero_parcelas < 1)) {
            throw new \InvalidArgumentException('invalid value for $numero_parcelas when calling IncluirContratoDTO., must be bigger than or equal to 1.');
        }
    ...
    public function setValorParcela($valor_parcela)
    {
        ...
        if (($valor_parcela < 0)) {
            throw new \InvalidArgumentException('invalid value for $valor_parcela when calling IncluirContratoDTO., must be bigger than or equal to 0.');
        }
    ...
    public function setValorGlobal($valor_global)
    {
        ...
        if (($valor_global < 0)) {
            throw new \InvalidArgumentException('invalid value for $valor_global when calling IncluirContratoDTO., must be bigger than or equal to 0.');
        }
    ...
    public function setNomeRazaoSocialFornecedorSubContratado($nome_razao_social_fornecedor_sub_contratado)
    {
        ...
        if ((mb_strlen($nome_razao_social_fornecedor_sub_contratado) > 255)) {
            throw new \InvalidArgumentException('invalid length for $nome_razao_social_fornecedor_sub_contratado when calling IncluirContratoDTO., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($nome_razao_social_fornecedor_sub_contratado) < 0)) {
            throw new \InvalidArgumentException('invalid length for $nome_razao_social_fornecedor_sub_contratado when calling IncluirContratoDTO., must be bigger than or equal to 0.');
        }
