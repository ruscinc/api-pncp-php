...
/**
 * EventoNotaFiscalConsultaDTO Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class EventoNotaFiscalConsultaDTO implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'EventoNotaFiscalConsultaDTO';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('evento', $data ?? [], null);
        $this->setIfExists('motivo_evento', $data ?? [], null);
    }
    ...
    */
     ...
     * Sets data_evento
     *
     * @param string|null $data_evento data_evento
     *
     * @return self
     */
     ...
     * Sets evento
     *
     * @param string|null $evento evento
     *
     * @return self
     */
    ...
    {
        if (is_null($evento)) {
            throw new \InvalidArgumentException('non-nullable evento cannot be null');
        }
     ...
     * @return string|null
     */
    public function getMotivoEvento()
    {
        return $this->container['motivo_evento'];
    }

    /**
     * Sets motivo_evento
     *
     * @param string|null $motivo_evento motivo_evento
     *
     * @return self
     */
    public function setMotivoEvento($motivo_evento)
    {
        if (is_null($motivo_evento)) {
            throw new \InvalidArgumentException('non-nullable motivo_evento cannot be null');
        }
        $this->container['motivo_evento'] = $motivo_evento;
