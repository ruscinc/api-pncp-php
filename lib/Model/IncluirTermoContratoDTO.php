...
/**
 * IncluirTermoContratoDTO Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class IncluirTermoContratoDTO implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'IncluirTermoContratoDTO';
    ...
    */
    ...
    public function setTipoTermoContratoId($tipo_termo_contrato_id)
    {
        ...
        if (($tipo_termo_contrato_id < 1)) {
            throw new \InvalidArgumentException('invalid value for $tipo_termo_contrato_id when calling IncluirTermoContratoDTO., must be bigger than or equal to 1.');
        }
    ...
    public function setNomeRazaoSocialFornecedor($nome_razao_social_fornecedor)
    {
        ...
        if ((mb_strlen($nome_razao_social_fornecedor) > 255)) {
            throw new \InvalidArgumentException('invalid length for $nome_razao_social_fornecedor when calling IncluirTermoContratoDTO., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($nome_razao_social_fornecedor) < 0)) {
            throw new \InvalidArgumentException('invalid length for $nome_razao_social_fornecedor when calling IncluirTermoContratoDTO., must be bigger than or equal to 0.');
        }
    ...
    public function setNomeRazaoSocialFornecedorSubContratado($nome_razao_social_fornecedor_sub_contratado)
    {
        ...
        if ((mb_strlen($nome_razao_social_fornecedor_sub_contratado) > 255)) {
            throw new \InvalidArgumentException('invalid length for $nome_razao_social_fornecedor_sub_contratado when calling IncluirTermoContratoDTO., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($nome_razao_social_fornecedor_sub_contratado) < 0)) {
            throw new \InvalidArgumentException('invalid length for $nome_razao_social_fornecedor_sub_contratado when calling IncluirTermoContratoDTO., must be bigger than or equal to 0.');
        }
